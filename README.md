...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mizuroute-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mizuroute-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `mizuroute` available on your platform:
...
```
pixi search mizuroute --channel conda-forge
```
